...
const LOCAL_SHOWCASE_IMAGES = [
  "/studio-showcase/caricature-trend.png",
  "/studio-showcase/lunar-new-year.png",
  "/studio-showcase/flower-petals.png",
  "/studio-showcase/gold.png",
  "/studio-showcase/crayon.png",
  "/studio-showcase/paparazzi.png",
  "/studio-showcase/edit-image-tile.png",
] as const;

function resolveShowcaseImage(id: string): string {
  const numericId = Number.parseInt(id, 10);
  const imageIndex = Number.isFinite(numericId)
    ? (numericId - 1) % LOCAL_SHOWCASE_IMAGES.length
    : 0;

  return LOCAL_SHOWCASE_IMAGES[imageIndex] ?? LOCAL_SHOWCASE_IMAGES[0];
}

export const SHOWCASE_EXAMPLES: ShowcaseExample[] = [
  {
    id: "1",
    image: resolveShowcaseImage("1"),
    title: "超写实名人群像",
